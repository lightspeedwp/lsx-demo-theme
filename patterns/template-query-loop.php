...
<div class="wp-block-query alignfull">
	<!-- wp:post-template {"align":"full","layout":{"type":"default"}} -->
		...
		<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
			...
			<!-- wp:post-title {"isLink":true,"fontSize":"700"} /-->
			<!-- wp:post-content {"align":"full","fontSize":"400","layout":{"type":"constrained"}} /-->
			<!-- wp:post-date {"isLink":true,"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"fontSize":"300"} /-->
		</div>
		<!-- /wp:group -->
	<!-- /wp:post-template -->
