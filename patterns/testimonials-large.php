	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="min-height:100%">
				<!-- wp:heading {"className":"is-style-text-annotation","style":{"layout":{"selfStretch":"fit","flexSize":null}},"fontSize":"200"} -->
				<h2 class="wp-block-heading is-style-text-annotation has-200-font-size"><?php echo esc_html_x( 'What people are saying', 'Testimonial heading.', 'lsx-demo-theme' ); ?></h2>
				<!-- /wp:heading -->

				<!-- wp:quote {"className":"is-style-plain","style":{"spacing":{"blockGap":"var:preset|spacing|50"},"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"700"} -->
				<blockquote class="wp-block-quote is-style-plain has-700-font-size" style="font-style:normal;font-weight:400">
					...
					<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
						...
						<p class="has-800-font-size"><?php echo esc_html_x( '“Superb product and customer service!”', 'Sample testimonial.', 'lsx-demo-theme' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
